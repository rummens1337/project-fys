...
<html>
    ...
    <body>
        ...
        <nav>
            <ul>
                <li><a href="index_en.php">Homepage</a></li>
                <li><a href="gallerij_en.php">Gallery</a></li>
                <li><a class="active" href="contact_en.php">Contact</a></li>
...
//Wanneer het formulier nog niet verzonden is wordt deze weergegeven
            if (!isset($_POST['submit'])) {
                ?>
                <h3>Do you have a question or remark?</h3>
                <form action="contact_en.php" method="POST">
                    Firstname:<br>
                    <input type="text" name="voornaam" placeholder="Firstname" required><br><br>
                    Lastname:<br>
                    <input type="text" name="achternaam" placeholder="Lastname" required><br><br>
                    E-mail:<br>
                    <input type="email" name="email" placeholder="E-mail" required /><br><br>
                    Your question or remark:<br>
                    <textarea type="text" name="text" placeholder="type your question or remark here" required style="height:200px;width:400px" ></textarea><br>
                    <input type="submit" name="submit" value="Verzenden">
                    <br>
                    <br><br><br><br>
                </form>
            <?php } else { ?>
                We have received your form in good order <br> And will respond as soon as possible
            <?php } ?>
        </fieldset>
